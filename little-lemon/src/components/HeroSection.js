...
const HeroSection = () => {
  ...
  return (
    <section className="relative bg-[#5E7263] w-full py-10" aria-labelledby="hero-heading">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-8">
        <div className="md:w-1/2 w-full py-2 md:py-0">
          <h1 id="hero-heading" className="text-3xl md:text-5xl font-bold text-[#D9A900] leading-tight mb-2">Little Lemon</h1>
